...
# Image Functions
mlx.mlx_put_pixel.argtypes = [
    ctypes.POINTER(mlx_image_t), c_uint32, c_uint32, c_uint32
    ]
...
mlx.mlx_delete_image.argtypes = [
    ctypes.POINTER(mlx_t), ctypes.POINTER(mlx_image_t)
    ]
mlx.mlx_delete_image.restype = None

# Input
mlx.mlx_is_key_down.argtypes = [
    ctypes.POINTER(mlx_t), ctypes.c_int
    ]
mlx.mlx_is_key_down.restype = c_bool

# Hooks
mlx.mlx_loop_hook.argtypes = [
    ctypes.POINTER(mlx_t), mlx_loop_hook_func, c_void_p
    ]
...
mlx.mlx_mouse_hook.argtypes = [
    ctypes.POINTER(mlx_t), mlx_mousefunc, c_void_p
    ]
mlx.mlx_mouse_hook.restype = None

mlx.mlx_cursor_hook.argtypes = [
    ctypes.POINTER(mlx_t), mlx_cursorfunc, c_void_p
    ]
